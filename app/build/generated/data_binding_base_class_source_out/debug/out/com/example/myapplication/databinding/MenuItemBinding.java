...
public final class MenuItemBinding implements ViewBinding {
  ...
  private MenuItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView menuImage,
  ...
  public static MenuItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MenuItemBinding((LinearLayout) rootView, menuImage, menuName, menuPrice);
    }
